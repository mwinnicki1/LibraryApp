...
namespace LibraryApp.Controllers
{
    public class BorrowBookController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BorrowId,BookId")] BorrowBook borrowBook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BorrowId,BookId")] BorrowBook borrowBook)
        {
            if (ModelState.IsValid)
            {
